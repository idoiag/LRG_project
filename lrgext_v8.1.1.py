...
given a HGVS gene (case insensitive). The different coordinates are includes into a
.csv, tab separated file. Also a bed file will be created. The scripts supports 
LRG files with more than one Transcrip versions.
    
Usage example: python lrgext_v7.1.py BRCA1
"""
...
enter_gene = "MRE11" # For testing purposes
