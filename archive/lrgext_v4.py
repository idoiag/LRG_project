...
def output2file(list_all_coord):
...
- Adding examples of initial and final test: v2
- Extracting exon, transcript and protein coordinates: v3
- Output: it creates a csv and tab separate text file: v3
- Dealing with more than one transcript v.4
- Adding disclaimer v.4
