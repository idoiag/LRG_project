...
def coord2file(opath, list_all_coord, list4bed, lrg_id):
    """
...
def diff2file (opath, build_data, diff_data, lrg_id):
...
def main():
    ...
    (data, LRG_xml)=initial_tests(path)
    ...
    coord2file(opath, list_all_coord, list4bed, lrg_id)
    diff2file(opath, build_data, diff_data, lrg_id)
