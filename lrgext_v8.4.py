...
def final_tests(tot_exons,count, schema, str_dir, lrg_size_38, lrg_size_37, gene_len_38):
    """
...
def main():
    ...
    final_tests(tot_exons, count, schema,  str_dir, lrg_size_38, lrg_size_38, gene_len_38)
    disclaimer()
